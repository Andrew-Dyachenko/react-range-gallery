			...
			<div className='App'>
				<div className='container App__container'>
					...
					{loading ? (
						...
						<Fragment>
							<RangeGallery dataList={dataList}>
					...
					<ul className="abbrs App__abbrs">
						<li className="abbrs__item">
							<abbr title="RRGA - React Range Gallery application">RRGA</abbr>
							&nbsp;-&nbsp;<samp>{RRGAv}</samp>
						</li>
						<li className="abbrs__item">
							<abbr title="RRG - React Range Gallery">RRG</abbr>&nbsp;-&nbsp;
							<samp>{RRGv}</samp>
						</li>
					</ul>
					<address className="address App__address">
						<a
							href="https://github.com/Andrew-Dyachenko/react-range-gallery"
							rel="noopener noreferrer"
							target="_blank"
							className="address__item address__item--github"
						>
							<img
								src={ghIcon}
								width="16"
							...
							/>
							<span className="address__icon">Github</span>
						</a>
					</address>
				</div>
			</div>
